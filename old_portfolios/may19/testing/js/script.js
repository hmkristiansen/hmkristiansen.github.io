...
var initiated = false;
var possibleClasses = ["about","work","contact"];

$('.greeting').click(function() {
    $('.logo2').toggleClass('none');
    $('.menu-item').toggleClass('none');
    $('.menu-item').removeClass('blur');
    $('.desktop').toggleClass('none');
    $('body').toggleClass('body_color');

    for(var i=0; i<possibleClasses.length; i++){
      $("."+possibleClasses[i]).removeClass('blur');
      $("." + possibleClasses[i] + "_page").addClass('none');
    }
...
$(".menu-item").on('click', function(event){
  ...
  var currentPage = "." + currentItem + "_page";
  
  for(var i=0; i<possibleClasses.length; i++){
    if(possibleClasses[i] == currentItem){
      $(currentPage).addClass('none');
      $(this).addClass('blur');
    }else{
      $("."+possibleClasses[i]).removeClass('blur');
      $("." + possibleClasses[i] + "_page").removeClass('none');
    }
  }
...
if((isMobile == false) && (initiated == false)){
    (function() {
    // Init
  ...
  //Dynamic shadow. Written by Tobias Wulvik & Olve Sigurd Steen
