...
var expo = [
	...
	[["Client","Design EXPO"],["Role", "Web designer & developer 🦄"],["Period", "Autumn '18"]],
	["Design EXPO is an annual fund raiser for students in the 3rd class toward an exclusion to a chosen country. <br>I was tasked with making the website for event with information and registration. <br><br>The website was meant to be very simple, but follow the graphic profile of this years fund raiser. This year’s theme “Mind the mind” adopted colourful and isometric graphics. To complement this I made the website come alive with a subtle, dynamic gradient and mouse-triggered parallax effects. "],
	["01","02","03"]
];
...
var lighting = [
	...
	["Besides my studies, I’ve been fortunate to be one of the amazing volunteers at the"+ '<a href=“https://www.samfundet.no/” target=“_blank” class=“ext-link”> Student Society in Trondheim</a>'+", and also dip my toes in light design.<br><br>Foto: Fotogjengen Samfundet"],
	["01","02"]
